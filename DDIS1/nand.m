...
plotsig(transientsim, 'v_in1,v_in2;v_out');  %The transient simulation is stored in transientsim, make a plot

time        = evalsig(transientsim, 'TIME');
n1          = evalsig(transientsim, 'v_in1');
n2          = evalsig(transientsim, 'v_out');
